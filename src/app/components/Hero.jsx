    ...
    <div className="flex flex-col m-3 md:m-6 relative bg-gradient-to-br from-[#1a0007] via-[#080405] to-[#2d0b13] rounded-lg z-20">
      ...
      <section ref={sectionRef} className="relative min-h-4/5 py-10 flex flex-col justify-center w-full ">
        <div className="relative z-10 flex flex-col items-center text-center px-4 md:py-16">
          <h1 className={`text-4xl md:text-8xl font-extrabold text-white leading-tight mb-2 md:mb-6 max-w-3xl mx-auto ${isVisible ? 'animate__animated animate__fadeInUp' : 'opacity-0'}`}>
            Rent{' '}
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-2 md:mb-6">
            <a href="#" className={`inline-flex items-center justify-center bg-[#E60023] hover:bg-[#b8001a] text-white px-7 py-3 rounded-full font-semibold hover:shadow-[#E60023]/60 hover:scale-[1.05] transition text-sm md:text-base ${isVisible ? 'animate__animated animate__fadeInLeft animate__delay-2s' : 'opacity-0'}`}>
              Download on App Store <ArrowRight className="ml-2 w-5 h-5" />
            </a>
            <a href="#" className={`inline-flex items-center justify-center border border-white text-white px-7 py-3 rounded-full font-semibold hover:bg-white/15 hover:shadow-white/50 hover:scale-[1.05] transition text-sm md:text-base ${isVisible ? 'animate__animated animate__fadeInRight animate__delay-2s' : 'opacity-0'}`}>
